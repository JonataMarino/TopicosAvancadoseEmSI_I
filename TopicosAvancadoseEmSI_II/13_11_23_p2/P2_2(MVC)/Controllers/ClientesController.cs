...
namespace P2_2_MVC_.Controllers
{
    public class ClientesController : Controller
    {
        ...
        public ClientesController(P2_2_MVC_Context context)
        {
            _context = context;
        }
        ...
        public IActionResult ClientesComPedidos()
        {
            var clientesComPedidos = _context.Cliente.Include(c => c.Pedidos).Where(c => c.Pedidos.Any()).ToList();
            return View(clientesComPedidos);
        }
    }
}
